...
import { ChevronLeft, ChevronRight, Camera, CheckCircle2, Store, MapPin, Briefcase, Globe, Loader2, AlertTriangle } from "lucide-react";
...
export default function ProviderRegisterPage() {
    ...
    const handleFinish = async () => {
        setSubmitting(true);
        setError(null);
        console.log("[PitGo] Starting provider registration...", formData);
        try {
            ...
            console.log("[PitGo] Registration result:", result);
            setSubmitting(false);
            ...
            console.error("[PitGo] Registration exception:", err);
            setSubmitting(false);
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            {CATEGORY_OPTIONS.map((cat) => (
                                <div
                                    ...
                                    className={`flex items-center p-4 border rounded-2xl cursor-pointer transition-all ${formData.categories.includes(cat)
                                            ? "bg-primary/10 border-primary shadow-md"
                                            : "bg-card border-border hover:border-primary/50"
                                        }`}
                                >
                                    <div className={`h-5 w-5 rounded-lg border-2 mr-3 flex items-center justify-center transition-colors ${formData.categories.includes(cat) ? "bg-primary border-primary" : "border-border"
                                        }`}>
                    ...
                    <div className="space-y-6 animate-in slide-in-from-right duration-300">
                        ...
                        {error && (
                            <div className="flex items-start gap-3 p-4 bg-red-500/10 border border-red-500/30 rounded-2xl">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-red-400">Erro no Registro</p>
